...
class FeedbackFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val binding = inflater.inflate(R.layout.settings_feedback_fragment, container, false)
        ...
        appHeader.text = (activity as MainActivity).getString(R.string.feedback_heading)
        appHeader.typeface =
