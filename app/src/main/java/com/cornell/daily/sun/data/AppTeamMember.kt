...
enum class AppTeamMember(
    ...
    CHRIS(
        ...
        "Developer",
        "Naples, Florida",
        "What's the worst that can happens?"
    ),
    BRENDAN(
        4,
        "\uD83D\uDC68\uD83C\uDFFB\u200D\uD83D\uDCBB",
        "Brendan Elliott '19",
        "Designer",
        "Grnad Rapids, Michigan",
        "Ketchup should never be used before noon"
    ),
    ALEXIS(
        5,
        "\uD83D\uDC83",
        ...
        "Designer",
        "Mamaroneck, New York",
        "The solution is in the framing of the problem"
    ),
    ADITYA(
        6,
        "\uD83D\uDC2A",
